...
//     return this.http.post(`${this.baseUrl}Client/getChartClient`, body, { headers: this.headers });
//   }

//   // GET MENU for sidebar (expects { user_id: number })
//   getMenu(body: any): Observable<any> {
//     return this.http.post(`${this.baseUrl}Client/getMenu`, body, { headers: this.headers });
//   }

//   // GET CLIENT ZONES (STATES)
// getClientZone(): Observable<any> {
//   return this.http.get(`${this.baseUrl}Client/getClientZone`, { headers: this.headers });
// }
// // INSERT CLIENT ZONE (STATE)
// insertClientZone(body: any) {
...
export class ApiService {
  ...
  login(data: { emp_code: string; emp_password: string }): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.login}`,
      data,
      { headers: this.headers }
    );
  }
...
getMenu(body: any): Observable<any> {
  ...
  getClients(): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.baseUrl}${environment.endpoints.getClient}`,
      { headers: this.headers }
    );
  }
  ...
  addClient(data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.insertClient}`,
      data,
      { headers: this.headers }
    );
  }
  ...
  updateClient(data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.updateClient}`,
      data,
      { headers: this.headers }
    );
  }
  ...
  getStates(): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.baseUrl}${environment.endpoints.getState}`,
      { headers: this.headers }
    );
  }
  ...
  insertState(data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.insertState}`,
      data,
      { headers: this.headers }
    );
  }
  ...
  updateState(data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.updateState}`,
      data,
      { headers: this.headers }
    );
  }
  ...
  getCities(): Observable<any[]> {
    return this.http.get<any[]>(
      `${this.baseUrl}${environment.endpoints.getCity}`,
      { headers: this.headers }
    );
  }

  // INSERT CLIENT ZONE
  insertClientZone(body: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.insertClientZone}`,
      body,
      { headers: this.headers }
    );
  }
...
getClientZone(): Observable<any> {
  return this.http.get(
    `${this.baseUrl}${environment.endpoints.getClientZone}`,
    { headers: this.headers }
  );
}
...
updateClientZone(body: any): Observable<any> {
  ...
  getLocationByCity(cityId: number): Observable<any[]> {
    return this.http.post<any[]>(
      `${this.baseUrl}${environment.endpoints.getLocationByCity}`,
      { id: cityId },
      { headers: this.headers }
    );
  }
  ...
  addLocation(data: any): Observable<any> {
    return this.http.post(
      `${this.baseUrl}${environment.endpoints.insertLocation}`,
      data,
      { headers: this.headers }
    );
}
